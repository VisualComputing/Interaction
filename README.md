## Visual Computing Slides -- Interaction
...
## Installation
 ...
 ```sh
 $ git clone https://github.com/VisualComputing/Interaction.git
 $ cd Interaction
...
3. Install dependencies (you must be already on the presentation folder, otherwise ```$ cd Interaction```)
